/** File ToolkitBasic.java - a class with general tools, version 06, 2015-07-21
...
public class ToolkitBasic {
   ...
   final static public char OUTPUT_MODE_SCREEN  = 'S';   // Output to screen
   final static public char OUTPUT_MODE_FILE    = 'F';   // Output to a file
   final static public char OUTPUT_MODE_BOTH    = 'B';   // Output to both
   final static public char OUTPUT_MODE_DEFAULT = OUTPUT_MODE_SCREEN;
                                                         // Default output mode
   final static public char OUTPUT_MODE_INVALID = '?';   // Invalid output mode
   ...
   final static private String OUTPUT_COUNT_DELIMETER = ")  ";  // For printed line #s
   final static private char OUTPUT_SHOW_COUNT_YES = 'Y';   // Show output line count
   final static private char OUTPUT_SHOW_COUNT_NO  = 'N';   // Don't show line count
   final static private char OUTPUT_SHOW_COUNT     = OUTPUT_SHOW_COUNT_YES;
   
   private static char outputMode;        // Output mode for outputLine()
                                          // ... Set by a constructor
   private static PrintWriter outputFile = null; // Set by a Constr'r for outputLine()
   private static int outputLineCounter = 0;     // Counts lines done in outputLine()
   ...
   */
   ...
   public ToolkitBasic(char outMode) {
   ...
   */
   public ToolkitBasic(char outMode, FileWriter outputFileName) {
   ...
   */
   ...
   public static void setOutputMode(char outMode) {
   ...
   */
   ...
   public static char getOutputMode() {
      return outputMode;
   } // End getOutputMode
  ...
  */
   ...
   */     
   ...
   public static void outputLine(String theLine) {
  ...
  /** repeat
      repeat a string a certain number of times  
       ...
       Examples   repeat("-",10) returns "----------"
                  repeat("<>",5) returns "<><><><><>"
                  repeat("[ ],3) returns "[ ][ ][ ]"
                  repeat(null,9) returns ""
  */
   ...
   // **************************************************************************
    ...
    private static String getClassInfoStackTrace() {
        ...
        for(int i = 1; i < stElements.length; i++){
            ...
            if(!ste.getClassName().equals(ToolkitBasic.class.getName()) && 
